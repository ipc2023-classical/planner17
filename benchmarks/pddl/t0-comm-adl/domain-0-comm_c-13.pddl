...
(when (kBAD_P11__NOISY_P11) (and (kIN-CHANNEL_P11__NOISY_P11) (k-NOISY_P11__NOISY_P11) (not(kNOISY_P11__NOISY_P11)) (not(kREAD_P11__NOISY_P11)) (not(kBAD_P11__NOISY_P11)))) ;; Support.  Cancellation. 
(when (not(k-BAD_P11)) (and (not(k-IN-CHANNEL_P11)) (not(kNOISY_P11)) (not(kREAD_P11)))) ;; Cancellation. 
))
(:action CERTIFY_P13
:parameters ()
