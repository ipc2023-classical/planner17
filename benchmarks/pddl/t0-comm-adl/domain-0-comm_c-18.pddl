...
(when (kBAD_P26__NOISY_P26) (and (kIN-CHANNEL_P26__NOISY_P26) (k-NOISY_P26__NOISY_P26) (not(kNOISY_P26__NOISY_P26)) (not(kREAD_P26__NOISY_P26)) (not(kBAD_P26__NOISY_P26)))) ;; Support.  Cancellation. 
(when (not(k-BAD_P26)) (and (not(k-IN-CHANNEL_P26)) (not(kNOISY_P26)) (not(kREAD_P26)))) ;; Cancellation. 
))
...
(when (kBAD_P11__NOISY_P11) (and (kIN-CHANNEL_P11__NOISY_P11) (not(kREAD_P11__NOISY_P11)) (k-NOISY_P11__NOISY_P11) (not(kNOISY_P11__NOISY_P11)) (not(kBAD_P11__NOISY_P11)))) ;; Support.  Cancellation. 
(when (not(k-BAD_P11)) (and (not(k-IN-CHANNEL_P11)) (not(kREAD_P11)) (not(kNOISY_P11)))) ;; Cancellation. 
))
...
(when (kBAD_P27__NOISY_P27) (and (k-NOISY_P27__NOISY_P27) (not(kNOISY_P27__NOISY_P27)) (kIN-CHANNEL_P27__NOISY_P27) (not(kREAD_P27__NOISY_P27)) (not(kBAD_P27__NOISY_P27)))) ;; Support.  Cancellation. 
(when (not(k-BAD_P27)) (and (not(kNOISY_P27)) (not(k-IN-CHANNEL_P27)) (not(kREAD_P27)))) ;; Cancellation. 
))
...
(when (kBAD_P28__NOISY_P28) (and (k-NOISY_P28__NOISY_P28) (not(kNOISY_P28__NOISY_P28)) (kIN-CHANNEL_P28__NOISY_P28) (not(kREAD_P28__NOISY_P28)) (not(kBAD_P28__NOISY_P28)))) ;; Support.  Cancellation. 
(when (not(k-BAD_P28)) (and (not(kNOISY_P28)) (not(k-IN-CHANNEL_P28)) (not(kREAD_P28)))) ;; Cancellation. 
))
...
(when (kBAD_P23__NOISY_P23) (and (k-NOISY_P23__NOISY_P23) (not(kNOISY_P23__NOISY_P23)) (not(kREAD_P23__NOISY_P23)) (not(kBAD_P23__NOISY_P23)) (kIN-CHANNEL_P23__NOISY_P23))) ;; Support.  Cancellation. 
(when (not(k-BAD_P23)) (and (not(kNOISY_P23)) (not(kREAD_P23)) (not(k-IN-CHANNEL_P23)))) ;; Cancellation. 
))
...
(when (kBAD_P24__NOISY_P24) (and (k-NOISY_P24__NOISY_P24) (not(kNOISY_P24__NOISY_P24)) (not(kREAD_P24__NOISY_P24)) (not(kBAD_P24__NOISY_P24)) (kIN-CHANNEL_P24__NOISY_P24))) ;; Support.  Cancellation. 
(when (not(k-BAD_P24)) (and (not(kNOISY_P24)) (not(kREAD_P24)) (not(k-IN-CHANNEL_P24)))) ;; Cancellation. 
))
