...
(when (kBAD_P29__NOISY_P29) (and (k-NOISY_P29__NOISY_P29) (not(kNOISY_P29__NOISY_P29)) (kIN-CHANNEL_P29__NOISY_P29) (not(kREAD_P29__NOISY_P29)) (not(kBAD_P29__NOISY_P29)))) ;; Support.  Cancellation. 
(when (not(k-BAD_P29)) (and (not(kNOISY_P29)) (not(k-IN-CHANNEL_P29)) (not(kREAD_P29)))) ;; Cancellation. 
))
(:action RESET_S21
:parameters ()
...
(when (kBAD_P14__NOISY_P14) (and (k-NOISY_P14__NOISY_P14) (not(kNOISY_P14__NOISY_P14)) (kIN-CHANNEL_P14__NOISY_P14) (not(kREAD_P14__NOISY_P14)) (not(kBAD_P14__NOISY_P14)))) ;; Support.  Cancellation. 
(when (not(k-BAD_P14)) (and (not(kNOISY_P14)) (not(k-IN-CHANNEL_P14)) (not(kREAD_P14)))) ;; Cancellation. 
))
(:action RESET_S15
:parameters ()
...
(when (kBAD_P25__NOISY_P25) (and (kIN-CHANNEL_P25__NOISY_P25) (k-NOISY_P25__NOISY_P25) (not(kNOISY_P25__NOISY_P25)) (not(kREAD_P25__NOISY_P25)) (not(kBAD_P25__NOISY_P25)))) ;; Support.  Cancellation. 
(when (not(k-BAD_P25)) (and (not(k-IN-CHANNEL_P25)) (not(kNOISY_P25)) (not(kREAD_P25)))) ;; Cancellation. 
))
(:action RESET_S14
:parameters ()
:precondition (and (kCURRENT-STAGE_S14))
...
(when (kBAD_P30__NOISY_P30) (and (k-NOISY_P30__NOISY_P30) (not(kNOISY_P30__NOISY_P30)) (not(kREAD_P30__NOISY_P30)) (not(kBAD_P30__NOISY_P30)) (kIN-CHANNEL_P30__NOISY_P30))) ;; Support.  Cancellation. 
(when (not(k-BAD_P30)) (and (not(kNOISY_P30)) (not(kREAD_P30)) (not(k-IN-CHANNEL_P30)))) ;; Cancellation. 
))
(:action RESET_S12
:parameters ()
:precondition (and (kCURRENT-STAGE_S12))
...
(when (kBAD_P12__NOISY_P12) (and (kIN-CHANNEL_P12__NOISY_P12) (k-NOISY_P12__NOISY_P12) (not(kNOISY_P12__NOISY_P12)) (not(kREAD_P12__NOISY_P12)) (not(kBAD_P12__NOISY_P12)))) ;; Support.  Cancellation. 
(when (not(k-BAD_P12)) (and (not(k-IN-CHANNEL_P12)) (not(kNOISY_P12)) (not(kREAD_P12)))) ;; Cancellation. 
))
(:action RESET_S38
:parameters ()
...
(when (kBAD_P33__NOISY_P33) (and (kIN-CHANNEL_P33__NOISY_P33) (not(kREAD_P33__NOISY_P33)) (k-NOISY_P33__NOISY_P33) (not(kNOISY_P33__NOISY_P33)) (not(kBAD_P33__NOISY_P33)))) ;; Support.  Cancellation. 
(when (not(k-BAD_P33)) (and (not(k-IN-CHANNEL_P33)) (not(kREAD_P33)) (not(kNOISY_P33)))) ;; Cancellation. 
))
