...
(when (kBAD_P33__NOISY_P33) (and (k-NOISY_P33__NOISY_P33) (not(kNOISY_P33__NOISY_P33)) (kIN-CHANNEL_P33__NOISY_P33) (not(kREAD_P33__NOISY_P33)) (not(kBAD_P33__NOISY_P33)))) ;; Support.  Cancellation. 
(when (not(k-BAD_P33)) (and (not(kNOISY_P33)) (not(k-IN-CHANNEL_P33)) (not(kREAD_P33)))) ;; Cancellation. 
))
...
(when (kBAD_P22__NOISY_P22) (and (k-NOISY_P22__NOISY_P22) (not(kNOISY_P22__NOISY_P22)) (kIN-CHANNEL_P22__NOISY_P22) (not(kREAD_P22__NOISY_P22)) (not(kBAD_P22__NOISY_P22)))) ;; Support.  Cancellation. 
(when (not(k-BAD_P22)) (and (not(kNOISY_P22)) (not(k-IN-CHANNEL_P22)) (not(kREAD_P22)))) ;; Cancellation. 
))
(:action RESET_S19
:parameters ()
...
(when (kBAD_P15__NOISY_P15) (and (k-NOISY_P15__NOISY_P15) (not(kNOISY_P15__NOISY_P15)) (kIN-CHANNEL_P15__NOISY_P15) (not(kREAD_P15__NOISY_P15)) (not(kBAD_P15__NOISY_P15)))) ;; Support.  Cancellation. 
(when (not(k-BAD_P15)) (and (not(kNOISY_P15)) (not(k-IN-CHANNEL_P15)) (not(kREAD_P15)))) ;; Cancellation. 
))
(:action RESET_S18
:parameters ()
...
(when (kBAD_P34__NOISY_P34) (and (k-NOISY_P34__NOISY_P34) (not(kNOISY_P34__NOISY_P34)) (kIN-CHANNEL_P34__NOISY_P34) (not(kREAD_P34__NOISY_P34)) (not(kBAD_P34__NOISY_P34)))) ;; Support.  Cancellation. 
(when (not(k-BAD_P34)) (and (not(kNOISY_P34)) (not(k-IN-CHANNEL_P34)) (not(kREAD_P34)))) ;; Cancellation. 
))
...
(when (kBAD_P35__NOISY_P35) (and (k-NOISY_P35__NOISY_P35) (not(kNOISY_P35__NOISY_P35)) (kIN-CHANNEL_P35__NOISY_P35) (not(kREAD_P35__NOISY_P35)) (not(kBAD_P35__NOISY_P35)))) ;; Support.  Cancellation. 
(when (not(k-BAD_P35)) (and (not(kNOISY_P35)) (not(k-IN-CHANNEL_P35)) (not(kREAD_P35)))) ;; Cancellation. 
))
...
(when (kBAD_P13__NOISY_P13) (and (kIN-CHANNEL_P13__NOISY_P13) (not(kREAD_P13__NOISY_P13)) (k-NOISY_P13__NOISY_P13) (not(kNOISY_P13__NOISY_P13)) (not(kBAD_P13__NOISY_P13)))) ;; Support.  Cancellation. 
(when (not(k-BAD_P13)) (and (not(k-IN-CHANNEL_P13)) (not(kREAD_P13)) (not(kNOISY_P13)))) ;; Cancellation. 
))
...
(when (kBAD_P18__NOISY_P18) (and (k-NOISY_P18__NOISY_P18) (not(kNOISY_P18__NOISY_P18)) (kIN-CHANNEL_P18__NOISY_P18) (not(kREAD_P18__NOISY_P18)) (not(kBAD_P18__NOISY_P18)))) ;; Support.  Cancellation. 
(when (not(k-BAD_P18)) (and (not(kNOISY_P18)) (not(k-IN-CHANNEL_P18)) (not(kREAD_P18)))) ;; Cancellation. 
))
...
(when (kBAD_P36__NOISY_P36) (and (k-NOISY_P36__NOISY_P36) (not(kNOISY_P36__NOISY_P36)) (not(kREAD_P36__NOISY_P36)) (not(kBAD_P36__NOISY_P36)) (kIN-CHANNEL_P36__NOISY_P36))) ;; Support.  Cancellation. 
(when (not(k-BAD_P36)) (and (not(kNOISY_P36)) (not(kREAD_P36)) (not(k-IN-CHANNEL_P36)))) ;; Cancellation. 
))
...
(when (kBAD_P20__NOISY_P20) (and (k-NOISY_P20__NOISY_P20) (not(kNOISY_P20__NOISY_P20)) (not(kREAD_P20__NOISY_P20)) (not(kBAD_P20__NOISY_P20)) (kIN-CHANNEL_P20__NOISY_P20))) ;; Support.  Cancellation. 
(when (not(k-BAD_P20)) (and (not(kNOISY_P20)) (not(kREAD_P20)) (not(k-IN-CHANNEL_P20)))) ;; Cancellation. 
))
...
(when (kBAD_P37__NOISY_P37) (and (k-NOISY_P37__NOISY_P37) (not(kNOISY_P37__NOISY_P37)) (not(kREAD_P37__NOISY_P37)) (not(kBAD_P37__NOISY_P37)) (kIN-CHANNEL_P37__NOISY_P37))) ;; Support.  Cancellation. 
(when (not(k-BAD_P37)) (and (not(kNOISY_P37)) (not(kREAD_P37)) (not(k-IN-CHANNEL_P37)))) ;; Cancellation. 
))
(:action RESET_S40
:parameters ()
:precondition (and (kCURRENT-STAGE_S40))
...
(when (kBAD_P30__NOISY_P30) (and (k-NOISY_P30__NOISY_P30) (not(kNOISY_P30__NOISY_P30)) (kIN-CHANNEL_P30__NOISY_P30) (not(kREAD_P30__NOISY_P30)) (not(kBAD_P30__NOISY_P30)))) ;; Support.  Cancellation. 
(when (not(k-BAD_P30)) (and (not(kNOISY_P30)) (not(k-IN-CHANNEL_P30)) (not(kREAD_P30)))) ;; Cancellation. 
))
...
(when (kBAD_P38__NOISY_P38) (and (kIN-CHANNEL_P38__NOISY_P38) (k-NOISY_P38__NOISY_P38) (not(kNOISY_P38__NOISY_P38)) (not(kREAD_P38__NOISY_P38)) (not(kBAD_P38__NOISY_P38)))) ;; Support.  Cancellation. 
(when (not(k-BAD_P38)) (and (not(k-IN-CHANNEL_P38)) (not(kNOISY_P38)) (not(kREAD_P38)))) ;; Cancellation. 
))
...
(when (kBAD_P16__NOISY_P16) (and (k-NOISY_P16__NOISY_P16) (not(kNOISY_P16__NOISY_P16)) (kIN-CHANNEL_P16__NOISY_P16) (not(kREAD_P16__NOISY_P16)) (not(kBAD_P16__NOISY_P16)))) ;; Support.  Cancellation. 
(when (not(k-BAD_P16)) (and (not(kNOISY_P16)) (not(k-IN-CHANNEL_P16)) (not(kREAD_P16)))) ;; Cancellation. 
))
...
(when (kBAD_P39__NOISY_P39) (and (kIN-CHANNEL_P39__NOISY_P39) (k-NOISY_P39__NOISY_P39) (not(kNOISY_P39__NOISY_P39)) (not(kREAD_P39__NOISY_P39)) (not(kBAD_P39__NOISY_P39)))) ;; Support.  Cancellation. 
(when (not(k-BAD_P39)) (and (not(k-IN-CHANNEL_P39)) (not(kNOISY_P39)) (not(kREAD_P39)))) ;; Cancellation. 
))
(:action RESET_S39
:parameters ()
:precondition (and (kCURRENT-STAGE_S39))
...
(when (kBAD_P27__NOISY_P27) (and (k-NOISY_P27__NOISY_P27) (not(kNOISY_P27__NOISY_P27)) (not(kREAD_P27__NOISY_P27)) (not(kBAD_P27__NOISY_P27)) (kIN-CHANNEL_P27__NOISY_P27))) ;; Support.  Cancellation. 
(when (not(k-BAD_P27)) (and (not(kNOISY_P27)) (not(kREAD_P27)) (not(k-IN-CHANNEL_P27)))) ;; Cancellation. 
))
(:action RESET_S38
:parameters ()
:precondition (and (kCURRENT-STAGE_S38))
...
(when (kBAD_P19__NOISY_P19) (and (k-NOISY_P19__NOISY_P19) (not(kNOISY_P19__NOISY_P19)) (not(kREAD_P19__NOISY_P19)) (not(kBAD_P19__NOISY_P19)) (kIN-CHANNEL_P19__NOISY_P19))) ;; Support.  Cancellation. 
(when (not(k-BAD_P19)) (and (not(kNOISY_P19)) (not(kREAD_P19)) (not(k-IN-CHANNEL_P19)))) ;; Cancellation. 
))
...
(when (kBAD_P31__NOISY_P31) (and (k-NOISY_P31__NOISY_P31) (not(kNOISY_P31__NOISY_P31)) (kIN-CHANNEL_P31__NOISY_P31) (not(kREAD_P31__NOISY_P31)) (not(kBAD_P31__NOISY_P31)))) ;; Support.  Cancellation. 
(when (not(k-BAD_P31)) (and (not(kNOISY_P31)) (not(k-IN-CHANNEL_P31)) (not(kREAD_P31)))) ;; Cancellation. 
))
...
(when (kBAD_P14__NOISY_P14) (and (kIN-CHANNEL_P14__NOISY_P14) (not(kREAD_P14__NOISY_P14)) (k-NOISY_P14__NOISY_P14) (not(kNOISY_P14__NOISY_P14)) (not(kBAD_P14__NOISY_P14)))) ;; Support.  Cancellation. 
(when (not(k-BAD_P14)) (and (not(k-IN-CHANNEL_P14)) (not(kREAD_P14)) (not(kNOISY_P14)))) ;; Cancellation. 
))
...
(when (kBAD_P24__NOISY_P24) (and (k-NOISY_P24__NOISY_P24) (not(kNOISY_P24__NOISY_P24)) (kIN-CHANNEL_P24__NOISY_P24) (not(kREAD_P24__NOISY_P24)) (not(kBAD_P24__NOISY_P24)))) ;; Support.  Cancellation. 
(when (not(k-BAD_P24)) (and (not(kNOISY_P24)) (not(k-IN-CHANNEL_P24)) (not(kREAD_P24)))) ;; Cancellation. 
))
(:action RESET_S32
:parameters ()
:precondition (and (kCURRENT-STAGE_S32))
...
(when (kBAD_P21__NOISY_P21) (and (k-NOISY_P21__NOISY_P21) (not(kNOISY_P21__NOISY_P21)) (kIN-CHANNEL_P21__NOISY_P21) (not(kREAD_P21__NOISY_P21)) (not(kBAD_P21__NOISY_P21)))) ;; Support.  Cancellation. 
(when (not(k-BAD_P21)) (and (not(kNOISY_P21)) (not(k-IN-CHANNEL_P21)) (not(kREAD_P21)))) ;; Cancellation. 
))
(:action RESET_S31
:parameters ()
:precondition (and (kCURRENT-STAGE_S31))
...
(when (kBAD_P28__NOISY_P28) (and (k-NOISY_P28__NOISY_P28) (not(kNOISY_P28__NOISY_P28)) (not(kREAD_P28__NOISY_P28)) (not(kBAD_P28__NOISY_P28)) (kIN-CHANNEL_P28__NOISY_P28))) ;; Support.  Cancellation. 
(when (not(k-BAD_P28)) (and (not(kNOISY_P28)) (not(kREAD_P28)) (not(k-IN-CHANNEL_P28)))) ;; Cancellation. 
))
...
(when (kBAD_P12__NOISY_P12) (and (kIN-CHANNEL_P12__NOISY_P12) (not(kREAD_P12__NOISY_P12)) (k-NOISY_P12__NOISY_P12) (not(kNOISY_P12__NOISY_P12)) (not(kBAD_P12__NOISY_P12)))) ;; Support.  Cancellation. 
(when (not(k-BAD_P12)) (and (not(k-IN-CHANNEL_P12)) (not(kREAD_P12)) (not(kNOISY_P12)))) ;; Cancellation. 
))
...
(when (kBAD_P32__NOISY_P32) (and (k-NOISY_P32__NOISY_P32) (not(kNOISY_P32__NOISY_P32)) (not(kREAD_P32__NOISY_P32)) (not(kBAD_P32__NOISY_P32)) (kIN-CHANNEL_P32__NOISY_P32))) ;; Support.  Cancellation. 
(when (not(k-BAD_P32)) (and (not(kNOISY_P32)) (not(kREAD_P32)) (not(k-IN-CHANNEL_P32)))) ;; Cancellation. 
))
(:action RESET_S26
:parameters ()
:precondition (and (kCURRENT-STAGE_S26))
...
(when (kBAD_P17__NOISY_P17) (and (k-NOISY_P17__NOISY_P17) (not(kNOISY_P17__NOISY_P17)) (not(kREAD_P17__NOISY_P17)) (not(kBAD_P17__NOISY_P17)) (kIN-CHANNEL_P17__NOISY_P17))) ;; Support.  Cancellation. 
(when (not(k-BAD_P17)) (and (not(kNOISY_P17)) (not(kREAD_P17)) (not(k-IN-CHANNEL_P17)))) ;; Cancellation. 
))
(:action RESET_S25
:parameters ()
:precondition (and (kCURRENT-STAGE_S25))
...
(when (kBAD_P25__NOISY_P25) (and (k-NOISY_P25__NOISY_P25) (not(kNOISY_P25__NOISY_P25)) (not(kREAD_P25__NOISY_P25)) (not(kBAD_P25__NOISY_P25)) (kIN-CHANNEL_P25__NOISY_P25))) ;; Support.  Cancellation. 
(when (not(k-BAD_P25)) (and (not(kNOISY_P25)) (not(kREAD_P25)) (not(k-IN-CHANNEL_P25)))) ;; Cancellation. 
))
(:action CERTIFY_P39
:parameters ()
