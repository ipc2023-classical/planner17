...
(when (kBAD_P36__NOISY_P36) (and (k-NOISY_P36__NOISY_P36) (not(kNOISY_P36__NOISY_P36)) (kIN-CHANNEL_P36__NOISY_P36) (not(kREAD_P36__NOISY_P36)) (not(kBAD_P36__NOISY_P36)))) ;; Support.  Cancellation. 
(when (not(k-BAD_P36)) (and (not(kNOISY_P36)) (not(k-IN-CHANNEL_P36)) (not(kREAD_P36)))) ;; Cancellation. 
))
...
(when (kBAD_P32__NOISY_P32) (and (kIN-CHANNEL_P32__NOISY_P32) (k-NOISY_P32__NOISY_P32) (not(kNOISY_P32__NOISY_P32)) (not(kREAD_P32__NOISY_P32)) (not(kBAD_P32__NOISY_P32)))) ;; Support.  Cancellation. 
(when (not(k-BAD_P32)) (and (not(k-IN-CHANNEL_P32)) (not(kNOISY_P32)) (not(kREAD_P32)))) ;; Cancellation. 
))
...
(when (kBAD_P41__NOISY_P41) (and (kIN-CHANNEL_P41__NOISY_P41) (k-NOISY_P41__NOISY_P41) (not(kNOISY_P41__NOISY_P41)) (not(kREAD_P41__NOISY_P41)) (not(kBAD_P41__NOISY_P41)))) ;; Support.  Cancellation. 
(when (not(k-BAD_P41)) (and (not(k-IN-CHANNEL_P41)) (not(kNOISY_P41)) (not(kREAD_P41)))) ;; Cancellation. 
))
(:action RESET_S31
:parameters ()
...
(when (kBAD_P27__NOISY_P27) (and (kIN-CHANNEL_P27__NOISY_P27) (not(kREAD_P27__NOISY_P27)) (k-NOISY_P27__NOISY_P27) (not(kNOISY_P27__NOISY_P27)) (not(kBAD_P27__NOISY_P27)))) ;; Support.  Cancellation. 
(when (not(k-BAD_P27)) (and (not(k-IN-CHANNEL_P27)) (not(kREAD_P27)) (not(kNOISY_P27)))) ;; Cancellation. 
))
(:action RESET_S24
:parameters ()
:precondition (and (kCURRENT-STAGE_S24))
...
(when (kBAD_P43__NOISY_P43) (and (not(kREAD_P43__NOISY_P43)) (k-NOISY_P43__NOISY_P43) (not(kNOISY_P43__NOISY_P43)) (not(kBAD_P43__NOISY_P43)) (kIN-CHANNEL_P43__NOISY_P43))) ;; Support.  Cancellation. 
(when (not(k-BAD_P43)) (and (not(kREAD_P43)) (not(kNOISY_P43)) (not(k-IN-CHANNEL_P43)))) ;; Cancellation. 
))
(:action RESET_S18
:parameters ()
:precondition (and (kCURRENT-STAGE_S18))
...
(when (kBAD_P30__NOISY_P30) (and (kIN-CHANNEL_P30__NOISY_P30) (not(kREAD_P30__NOISY_P30)) (k-NOISY_P30__NOISY_P30) (not(kNOISY_P30__NOISY_P30)) (not(kBAD_P30__NOISY_P30)))) ;; Support.  Cancellation. 
(when (not(k-BAD_P30)) (and (not(k-IN-CHANNEL_P30)) (not(kREAD_P30)) (not(kNOISY_P30)))) ;; Cancellation. 
))
...
(when (kBAD_P44__NOISY_P44) (and (not(kREAD_P44__NOISY_P44)) (k-NOISY_P44__NOISY_P44) (not(kNOISY_P44__NOISY_P44)) (not(kBAD_P44__NOISY_P44)) (kIN-CHANNEL_P44__NOISY_P44))) ;; Support.  Cancellation. 
(when (not(k-BAD_P44)) (and (not(kREAD_P44)) (not(kNOISY_P44)) (not(k-IN-CHANNEL_P44)))) ;; Cancellation. 
))
...
(when (kBAD_P34__NOISY_P34) (and (not(kREAD_P34__NOISY_P34)) (k-NOISY_P34__NOISY_P34) (not(kNOISY_P34__NOISY_P34)) (not(kBAD_P34__NOISY_P34)) (kIN-CHANNEL_P34__NOISY_P34))) ;; Support.  Cancellation. 
(when (not(k-BAD_P34)) (and (not(kREAD_P34)) (not(kNOISY_P34)) (not(k-IN-CHANNEL_P34)))) ;; Cancellation. 
))
(:action RESET_S56
:parameters ()
...
(when (kBAD_P39__NOISY_P39) (and (kIN-CHANNEL_P39__NOISY_P39) (not(kREAD_P39__NOISY_P39)) (k-NOISY_P39__NOISY_P39) (not(kNOISY_P39__NOISY_P39)) (not(kBAD_P39__NOISY_P39)))) ;; Support.  Cancellation. 
(when (not(k-BAD_P39)) (and (not(k-IN-CHANNEL_P39)) (not(kREAD_P39)) (not(kNOISY_P39)))) ;; Cancellation. 
))
(:action RESET_S54
:parameters ()
:precondition (and (kCURRENT-STAGE_S54))
...
(when (kBAD_P47__NOISY_P47) (and (not(kREAD_P47__NOISY_P47)) (k-NOISY_P47__NOISY_P47) (not(kNOISY_P47__NOISY_P47)) (not(kBAD_P47__NOISY_P47)) (kIN-CHANNEL_P47__NOISY_P47))) ;; Support.  Cancellation. 
(when (not(k-BAD_P47)) (and (not(kREAD_P47)) (not(kNOISY_P47)) (not(k-IN-CHANNEL_P47)))) ;; Cancellation. 
))
...
(when (kBAD_P48__NOISY_P48) (and (not(kREAD_P48__NOISY_P48)) (k-NOISY_P48__NOISY_P48) (not(kNOISY_P48__NOISY_P48)) (not(kBAD_P48__NOISY_P48)) (kIN-CHANNEL_P48__NOISY_P48))) ;; Support.  Cancellation. 
(when (not(k-BAD_P48)) (and (not(kREAD_P48)) (not(kNOISY_P48)) (not(k-IN-CHANNEL_P48)))) ;; Cancellation. 
))
...
(when (kBAD_P49__NOISY_P49) (and (kIN-CHANNEL_P49__NOISY_P49) (not(kREAD_P49__NOISY_P49)) (k-NOISY_P49__NOISY_P49) (not(kNOISY_P49__NOISY_P49)) (not(kBAD_P49__NOISY_P49)))) ;; Support.  Cancellation. 
(when (not(k-BAD_P49)) (and (not(k-IN-CHANNEL_P49)) (not(kREAD_P49)) (not(kNOISY_P49)))) ;; Cancellation. 
))
...
(when (kBAD_P35__NOISY_P35) (and (not(kREAD_P35__NOISY_P35)) (k-NOISY_P35__NOISY_P35) (not(kNOISY_P35__NOISY_P35)) (not(kBAD_P35__NOISY_P35)) (kIN-CHANNEL_P35__NOISY_P35))) ;; Support.  Cancellation. 
(when (not(k-BAD_P35)) (and (not(kREAD_P35)) (not(kNOISY_P35)) (not(k-IN-CHANNEL_P35)))) ;; Cancellation. 
))
(:action RESET_S48
:parameters ()
:precondition (and (kCURRENT-STAGE_S48))
...
(when (kBAD_P26__NOISY_P26) (and (not(kREAD_P26__NOISY_P26)) (k-NOISY_P26__NOISY_P26) (not(kNOISY_P26__NOISY_P26)) (not(kBAD_P26__NOISY_P26)) (kIN-CHANNEL_P26__NOISY_P26))) ;; Support.  Cancellation. 
(when (not(k-BAD_P26)) (and (not(kREAD_P26)) (not(kNOISY_P26)) (not(k-IN-CHANNEL_P26)))) ;; Cancellation. 
))
