...
:effect (and 
(when(and (k-AT_N1) (k-AT_N2) (k-AT_N3))  (kAT_N4)) ;;reasoning over static clause. 
(when(and (k-AT_N4) (k-AT_N1) (k-AT_N2))  (kAT_N3)) ;;reasoning over static clause. 
(when(and (k-AT_N4) (k-AT_N1) (k-AT_N3))  (kAT_N2)) ;;reasoning over static clause. 
(when(and (k-AT_N4) (k-AT_N2) (k-AT_N3))  (kAT_N1)) ;;reasoning over static clause. 
))
...
:effect (and 
(when(and (kVISITED_N1__AT_N4) (kVISITED_N1__AT_N3) (kVISITED_N1__AT_N1) (kVISITED_N1__AT_N2))  (kVISITED_N1)) ;;MERGE. 
))
