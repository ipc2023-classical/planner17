...
(kAT_F0_P5)
(kAT_F0_P5__IN_E0_F1)
(kAT_F0_P5__-IN_E0_F1)
(kAT_F0_P7)
(kAT_F0_P7__IN_E1_F1)
(kAT_F0_P7__-IN_E1_F1)
(kHAVE_C0)
...
(kAT_F1_P5)
(kAT_F1_P5__IN_E0_F1)
(kAT_F1_P5__-IN_E0_F1)
(kAT_F1_P7)
(kAT_F1_P7__IN_E1_F1)
(kAT_F1_P7__-IN_E1_F1)
(kIN_E0_F0)
(k-IN_E0_F0)
(kIN_E0_F0__IN_E0_F1)
...
:effect (and  (not(kAT_F1_P6)) (kAT_F1_P7__-IN_E1_F1) (kAT_F1_P7) (kAT_F1_P7__IN_E1_F1)
))
(:action MOVE-RIGHT_F1_P5_P6
:parameters ()
:precondition (and (kAT_F1_P5))

:effect (and  (not(kAT_F1_P5__-IN_E0_F1)) (kAT_F1_P6) (not(kAT_F1_P5__IN_E0_F1)) (not(kAT_F1_P5))
))
(:action MOVE-RIGHT_F1_P4_P5
:parameters ()
:precondition (and (kAT_F1_P4))

:effect (and  (kAT_F1_P5__-IN_E0_F1) (kAT_F1_P5) (not(kAT_F1_P4)) (kAT_F1_P5__IN_E0_F1)
))
(:action MOVE-LEFT_F1_P7_P6
:parameters ()
:precondition (and (kAT_F1_P7))

:effect (and  (not(kAT_F1_P7__-IN_E1_F1)) (kAT_F1_P6) (not(kAT_F1_P7__IN_E1_F1)) (not(kAT_F1_P7))
))
(:action MOVE-LEFT_F1_P5_P4
:parameters ()
:precondition (and (kAT_F1_P5))

:effect (and  (not(kAT_F1_P5__-IN_E0_F1)) (not(kAT_F1_P5__IN_E0_F1)) (not(kAT_F1_P5)) (kAT_F1_P4)
))
(:action MOVE-LEFT_F0_P7_P6
:parameters ()
:precondition (and (kAT_F0_P7))

:effect (and  (not(kAT_F0_P7)) (not(kAT_F0_P7__-IN_E1_F1)) (not(kAT_F0_P7__IN_E1_F1)) (kAT_F0_P6)
))
(:action MOVE-LEFT_F0_P6_P5
:parameters ()
:precondition (and (kAT_F0_P6))

:effect (and  (kAT_F0_P5__-IN_E0_F1) (kAT_F0_P5) (not(kAT_F0_P6)) (kAT_F0_P5__IN_E0_F1)
))
(:action MOVE-LEFT_F0_P5_P4
:parameters ()
:precondition (and (kAT_F0_P5))

:effect (and  (not(kAT_F0_P5)) (not(kAT_F0_P5__-IN_E0_F1)) (kAT_F0_P4) (not(kAT_F0_P5__IN_E0_F1))
))
...
(when (kIN_E1_F1__-IN_E1_F1) (and (kAT_F1_P7__-IN_E1_F1) (not(kINSIDE_E1__-IN_E1_F1)))) ;; Support.  Cancellation. 
))
...
(when (kIN_E1_F0__-IN_E1_F1) (and (kAT_F0_P7__-IN_E1_F1) (not(kINSIDE_E1__-IN_E1_F1)))) ;; Support.  Cancellation. 
))
(:action STEP-OUT_E0_F1_P5
:parameters ()
:precondition (and (kINSIDE_E0))

:effect (and 
(when (kIN_E0_F1)  (kAT_F1_P5)) ;; Support. 
(when (not(k-IN_E0_F1))  (not(kINSIDE_E0))) ;; Cancellation. 
(when (kIN_E0_F1__IN_E0_F1) (and (kAT_F1_P5__IN_E0_F1) (not(kINSIDE_E0__IN_E0_F1)))) ;; Support.  Cancellation. 
(when (kIN_E0_F1__-IN_E0_F1) (and (kAT_F1_P5__-IN_E0_F1) (not(kINSIDE_E0__-IN_E0_F1)))) ;; Support.  Cancellation. 
))
(:action STEP-OUT_E0_F0_P5
:parameters ()
:precondition (and (kINSIDE_E0))

:effect (and 
(when (kIN_E0_F0)  (kAT_F0_P5)) ;; Support. 
(when (not(k-IN_E0_F0))  (not(kINSIDE_E0))) ;; Cancellation. 
(when (kIN_E0_F0__IN_E0_F1) (and (kAT_F0_P5__IN_E0_F1) (not(kINSIDE_E0__IN_E0_F1)))) ;; Support.  Cancellation. 
(when (kIN_E0_F0__-IN_E0_F1) (and (kAT_F0_P5__-IN_E0_F1) (not(kINSIDE_E0__-IN_E0_F1)))) ;; Support.  Cancellation. 
))
...
(when (kIN_E1_F0__-IN_E1_F1) (and (kINSIDE_E1__-IN_E1_F1) (not(kAT_F0_P7__-IN_E1_F1)))) ;; Support.  Cancellation. 
))
(:action STEP-IN_E0_F0_P5
:parameters ()
:precondition (and (kAT_F0_P5))

:effect (and 
(when (kIN_E0_F0)  (kINSIDE_E0)) ;; Support. 
(when (not(k-IN_E0_F0))  (not(kAT_F0_P5))) ;; Cancellation. 
(when (kIN_E0_F0__IN_E0_F1) (and (kINSIDE_E0__IN_E0_F1) (not(kAT_F0_P5__IN_E0_F1)))) ;; Support.  Cancellation. 
(when (kIN_E0_F0__-IN_E0_F1) (and (kINSIDE_E0__-IN_E0_F1) (not(kAT_F0_P5__-IN_E0_F1)))) ;; Support.  Cancellation. 
))
...
:effect (and  (not(kAT_F1_P6)) (kAT_F1_P5__-IN_E0_F1) (kAT_F1_P5) (kAT_F1_P5__IN_E0_F1)
))
...
(when (kIN_E1_F1__-IN_E1_F1) (and (kINSIDE_E1__-IN_E1_F1) (not(kAT_F1_P7__-IN_E1_F1)))) ;; Support.  Cancellation. 
))
(:action STEP-IN_E0_F1_P5
:parameters ()
:precondition (and (kAT_F1_P5))

:effect (and 
(when (kIN_E0_F1)  (kINSIDE_E0)) ;; Support. 
(when (not(k-IN_E0_F1))  (not(kAT_F1_P5))) ;; Cancellation. 
(when (kIN_E0_F1__IN_E0_F1) (and (kINSIDE_E0__IN_E0_F1) (not(kAT_F1_P5__IN_E0_F1)))) ;; Support.  Cancellation. 
(when (kIN_E0_F1__-IN_E0_F1) (and (kINSIDE_E0__-IN_E0_F1) (not(kAT_F1_P5__-IN_E0_F1)))) ;; Support.  Cancellation. 
))
...
:effect (and  (kAT_F0_P7__-IN_E1_F1) (kAT_F0_P7) (not(kAT_F0_P6)) (kAT_F0_P7__IN_E1_F1)
))
(:action MOVE-RIGHT_F0_P5_P6
:parameters ()
:precondition (and (kAT_F0_P5))

:effect (and  (not(kAT_F0_P5)) (not(kAT_F0_P5__-IN_E0_F1)) (not(kAT_F0_P5__IN_E0_F1)) (kAT_F0_P6)
))
(:action MOVE-RIGHT_F0_P4_P5
:parameters ()
:precondition (and (kAT_F0_P4))

:effect (and  (kAT_F0_P5__-IN_E0_F1) (not(kAT_F0_P4)) (kAT_F0_P5) (kAT_F0_P5__IN_E0_F1)
))
...
:effect (and 
(when(and (kAT_F1_P7__IN_E1_F1) (kAT_F1_P7__-IN_E1_F1))  (kAT_F1_P7)) ;;MERGE. 
))
...
:effect (and 
(when(and (kAT_F1_P5__IN_E0_F1) (kAT_F1_P5__-IN_E0_F1))  (kAT_F1_P5)) ;;MERGE. 
))
...
:effect (and 
(when(and (kAT_F0_P7__IN_E1_F1) (kAT_F0_P7__-IN_E1_F1))  (kAT_F0_P7)) ;;MERGE. 
))
...
:effect (and 
(when(and (kAT_F0_P5__IN_E0_F1) (kAT_F0_P5__-IN_E0_F1))  (kAT_F0_P5)) ;;MERGE. 
))
)
