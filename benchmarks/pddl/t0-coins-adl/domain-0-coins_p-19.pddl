...
(kAT_F0_P7__IN_E1_F1)
(kHAVE_C0)
(kHAVE_C0__COIN-AT_C0_F2_P7)
(kHAVE_C0__COIN-AT_C0_F2_P6)
(kHAVE_C0__COIN-AT_C0_F2_P5)
(kHAVE_C0__COIN-AT_C0_F2_P4)
(kHAVE_C0__COIN-AT_C0_F2_P3)
(kHAVE_C0__COIN-AT_C0_F2_P2)
(kHAVE_C0__COIN-AT_C0_F2_P0)
(kHAVE_C0__COIN-AT_C0_F2_P1)
(kHAVE_C1)
...
(:action COLLECT_C0_F2_P7
:parameters ()
:precondition (and (kAT_F2_P7))

:effect (and  (k-COIN-AT_C0_F2_P7)
(when (kCOIN-AT_C0_F2_P7__COIN-AT_C0_F2_P7) (and (kHAVE_C0__COIN-AT_C0_F2_P7) (not(kCOIN-AT_C0_F2_P7__COIN-AT_C0_F2_P7)))) ;; Support.  Cancellation. 
))
(:action COLLECT_C0_F2_P6
:parameters ()
:precondition (and (kAT_F2_P6))

:effect (and  (k-COIN-AT_C0_F2_P6)
(when (kCOIN-AT_C0_F2_P6__COIN-AT_C0_F2_P6) (and (kHAVE_C0__COIN-AT_C0_F2_P6) (not(kCOIN-AT_C0_F2_P6__COIN-AT_C0_F2_P6)))) ;; Support.  Cancellation. 
))
(:action COLLECT_C0_F2_P5
:parameters ()
:precondition (and (kAT_F2_P5))

:effect (and  (k-COIN-AT_C0_F2_P5)
(when (kCOIN-AT_C0_F2_P5__COIN-AT_C0_F2_P5) (and (kHAVE_C0__COIN-AT_C0_F2_P5) (not(kCOIN-AT_C0_F2_P5__COIN-AT_C0_F2_P5)))) ;; Support.  Cancellation. 
))
(:action COLLECT_C0_F2_P4
:parameters ()
:precondition (and (kAT_F2_P4))

:effect (and  (k-COIN-AT_C0_F2_P4)
(when (kCOIN-AT_C0_F2_P4__COIN-AT_C0_F2_P4) (and (kHAVE_C0__COIN-AT_C0_F2_P4) (not(kCOIN-AT_C0_F2_P4__COIN-AT_C0_F2_P4)))) ;; Support.  Cancellation. 
))
(:action COLLECT_C0_F2_P3
:parameters ()
:precondition (and (kAT_F2_P3))

:effect (and  (k-COIN-AT_C0_F2_P3)
(when (kCOIN-AT_C0_F2_P3__COIN-AT_C0_F2_P3) (and (kHAVE_C0__COIN-AT_C0_F2_P3) (not(kCOIN-AT_C0_F2_P3__COIN-AT_C0_F2_P3)))) ;; Support.  Cancellation. 
))
(:action COLLECT_C0_F2_P2
:parameters ()
:precondition (and (kAT_F2_P2))

:effect (and  (k-COIN-AT_C0_F2_P2)
(when (kCOIN-AT_C0_F2_P2__COIN-AT_C0_F2_P2) (and (kHAVE_C0__COIN-AT_C0_F2_P2) (not(kCOIN-AT_C0_F2_P2__COIN-AT_C0_F2_P2)))) ;; Support.  Cancellation. 
))
(:action COLLECT_C0_F2_P1
:parameters ()
:precondition (and (kAT_F2_P1))

:effect (and  (k-COIN-AT_C0_F2_P1)
(when (kCOIN-AT_C0_F2_P1__COIN-AT_C0_F2_P1) (and (kHAVE_C0__COIN-AT_C0_F2_P1) (not(kCOIN-AT_C0_F2_P1__COIN-AT_C0_F2_P1)))) ;; Support.  Cancellation. 
))
...
:effect (and  (not(kAT_F2_P6)) (kAT_F2_P7__IN_E1_F2) (kAT_F2_P7__IN_E1_F0) (kAT_F2_P7__IN_E1_F1) (kAT_F2_P7)
))
...
:effect (and  (not(kAT_F2_P3__IN_E0_F2)) (not(kAT_F2_P3)) (not(kAT_F2_P3__IN_E0_F1)) (kAT_F2_P4) (not(kAT_F2_P3__IN_E0_F0))
))
(:action MOVE-RIGHT_F2_P2_P3
:parameters ()
:precondition (and (kAT_F2_P2))

:effect (and  (kAT_F2_P3__IN_E0_F1) (kAT_F2_P3) (kAT_F2_P3__IN_E0_F2) (not(kAT_F2_P2)) (kAT_F2_P3__IN_E0_F0)
))
...
:effect (and  (not(kAT_F1_P3__IN_E0_F2)) (not(kAT_F1_P3)) (not(kAT_F1_P3__IN_E0_F1)) (not(kAT_F1_P3__IN_E0_F0)) (kAT_F1_P4)
))
...
:effect (and  (not(kAT_F2_P7)) (not(kAT_F2_P7__IN_E1_F1)) (kAT_F2_P6) (not(kAT_F2_P7__IN_E1_F0)) (not(kAT_F2_P7__IN_E1_F2))
))
(:action MOVE-LEFT_F2_P3_P2
:parameters ()
:precondition (and (kAT_F2_P3))

:effect (and  (not(kAT_F2_P3__IN_E0_F2)) (kAT_F2_P2) (not(kAT_F2_P3)) (not(kAT_F2_P3__IN_E0_F1)) (not(kAT_F2_P3__IN_E0_F0))
))
(:action MOVE-LEFT_F1_P7_P6
:parameters ()
:precondition (and (kAT_F1_P7))

:effect (and  (not(kAT_F1_P7)) (not(kAT_F1_P7__IN_E1_F1)) (not(kAT_F1_P7__IN_E1_F0)) (kAT_F1_P6) (not(kAT_F1_P7__IN_E1_F2))
))
(:action MOVE-LEFT_F1_P3_P2
:parameters ()
:precondition (and (kAT_F1_P3))

:effect (and  (not(kAT_F1_P3__IN_E0_F2)) (not(kAT_F1_P3)) (not(kAT_F1_P3__IN_E0_F1)) (kAT_F1_P2) (not(kAT_F1_P3__IN_E0_F0))
))
(:action MOVE-LEFT_F0_P7_P6
:parameters ()
:precondition (and (kAT_F0_P7))

:effect (and  (not(kAT_F0_P7__IN_E1_F2)) (not(kAT_F0_P7)) (not(kAT_F0_P7__IN_E1_F1)) (kAT_F0_P6) (not(kAT_F0_P7__IN_E1_F0))
))
...
:effect (and  (kAT_F2_P3__IN_E0_F1) (kAT_F2_P3) (not(kAT_F2_P4)) (kAT_F2_P3__IN_E0_F2) (kAT_F2_P3__IN_E0_F0)
))
...
:effect (and  (kAT_F1_P3__IN_E0_F2) (kAT_F1_P3__IN_E0_F0) (not(kAT_F1_P4)) (kAT_F1_P3__IN_E0_F1) (kAT_F1_P3)
))
...
(:action COLLECT_C0_F2_P0
:parameters ()
:precondition (and (kAT_F2_P0))

:effect (and  (k-COIN-AT_C0_F2_P0)
(when (kCOIN-AT_C0_F2_P0__COIN-AT_C0_F2_P0) (and (kHAVE_C0__COIN-AT_C0_F2_P0) (not(kCOIN-AT_C0_F2_P0__COIN-AT_C0_F2_P0)))) ;; Support.  Cancellation. 
))
...
:effect (and 
(when(and (kHAVE_C0__COIN-AT_C0_F2_P7) (kHAVE_C0__COIN-AT_C0_F2_P6) (kHAVE_C0__COIN-AT_C0_F2_P5) (kHAVE_C0__COIN-AT_C0_F2_P4) (kHAVE_C0__COIN-AT_C0_F2_P3) (kHAVE_C0__COIN-AT_C0_F2_P2) (kHAVE_C0__COIN-AT_C0_F2_P0) (kHAVE_C0__COIN-AT_C0_F2_P1))  (kHAVE_C0)) ;;MERGE. 
))
