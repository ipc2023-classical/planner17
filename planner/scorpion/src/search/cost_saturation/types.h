...
using CPFunction = std::function<CostPartitioningHeuristic(
                                     const Abstractions &, const std::vector<int> &, const std::vector<int> &, const std::vector<int> &)>;
using TCPFunction = std::function<CostPartitioningHeuristic(
                                     const Abstractions &, const std::vector<int> &, RemainingTransitionCostFunction &, const std::vector<int> &, int)>;
