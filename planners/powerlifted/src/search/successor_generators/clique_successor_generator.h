          ...
          dynamic_preconds_with_constants()
    {
        std::sort(this->dynamic_preconds.begin(),
                  ...
                  [](const Atom &lhs, const Atom &rhs) -> bool {
                      ...
                      // TODO: Understand why it is beneficial to prioritize checking
                      // atoms with many free variables as early as possible.
...
public:
    ...
    long get_generated_total() const override { return generated_total_; }

    long get_generated_applicable() const override { return generated_applicable_; }
};
