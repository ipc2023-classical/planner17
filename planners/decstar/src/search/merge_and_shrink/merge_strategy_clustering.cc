...
MergeStrategyClustering::MergeStrategyClustering(
...
pair<int, int> MergeStrategyClustering::get_next() {
    // We did not already start merging an SCC/all finished Clustering, so we
