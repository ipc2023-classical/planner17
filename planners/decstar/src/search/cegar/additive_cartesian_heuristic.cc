...
static vector<CartesianHeuristicFunction> generate_heuristic_functions(
    ...
    return cost_saturation.generate_heuristic_functions(
        tasks::g_root_task); // TODO: was opts.get<shared_ptr<AbstractTask>>("transform")
}
...
int AdditiveCartesianHeuristic::compute_heuristic(const GlobalState &ancestor_state) {
    int sum_h = 0;
    // TODO: implement this
