...
enum class AbsMinimizationType {APPROX, REMAP_UNDER_APPROX, HEAVY_BRANCH, SHORT_PATHS};
...
enum class UCTRewardType {STATES, NODES, STATES_TIME, NODES_TIME, STATES_NODES, NONE, RAND};
