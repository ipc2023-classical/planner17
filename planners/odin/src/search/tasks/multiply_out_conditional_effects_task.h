...
class MultiplyOutConditionalEffectsTask : public DelegatingTask {
    ...
    */
    ...
    std::vector<std::vector<ExplicitEffect>> operators_effects;
...
public:
    explicit MultiplyOutConditionalEffectsTask(const std::shared_ptr<AbstractTask> &parent);
    ...
    virtual FactPair get_operator_effect(
        int op_index, int eff_index, bool is_axiom) const override;
    virtual int convert_operator_index_to_parent(int id) const override;
};
}
