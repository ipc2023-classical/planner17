...
class AbstractState {
    ...
    // This state's node in the context split tree
    // Used from construction
    NodeID split_node_id;

    CartesianSet cartesian_set;

public:
    AbstractState(int state_id, NodeID node_id, NodeID split_node_id, CartesianSet &&cartesian_set);
    ...
    */
    ...
    NodeID get_split_node_id() const;
